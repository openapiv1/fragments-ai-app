...
export const fragmentSchema = z.object({
  ...
  files: z.array(z.object({
    ...
    file_content: z.string().describe('Content of the file. Only runnable code is allowed.'),
  })).describe('Array of files to generate for the application. Always generate multiple files for a complete application structure.'),
})
